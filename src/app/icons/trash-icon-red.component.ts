...
@Component({
  ...
  <g>
    <path xmlns:default="http://www.w3.org/2000/svg" id="trash"
      ...
      style="fill: #f45b69;" vector-effect="non-scaling-stroke" />
  </g>
</svg>`,
  styles: ['']
})
export class TrashIconRedComponent {
