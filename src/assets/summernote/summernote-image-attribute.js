...
(function (factory) {
	...
	(function ($) {
		...
		$.extend(true, $.summernote.lang, {
			'en-US': {
				imageAttributes: {
					edit: 'Bildattribute  ändern',
					titleLabel: 'Titel',
					altLabel: 'Alternativer Text',
					captionLabel: 'Beschreibung',
					tooltip: 'Bildattribute  ändern',
					dialogSaveBtnMessage: 'Speichern',
					dialogTitle: 'Bildattribute  ändern',
					widthLabel: 'Breite',
					heightLabel: 'Höhe',
					linkHref: 'Link'
				}
			...
			'imageAttributes': function (context) {
				...
				this.initialize = function () {
					...
					var body = ` <div class="form-group">
								...
								<div class="form-group">
									...
									<input class="form-control note-input note-image-linkHref-text" type="text" />
								</div>`;
					...
					this.showLinkDialog(_imgInfo)
						.then(function (imgInfo) {
							...
							if (_imgInfo.title != imgInfo.title || _imgInfo.alt != imgInfo.alt || _imgInfo.caption != imgInfo.caption
								|| _imgInfo.width != imgInfo.width || _imgInfo.height != imgInfo.height || _imgInfo.linkHref != imgInfo.linkHref) {
							...
							if (imgInfo.linkHref) {
								...
								$img.wrap(linkBody);
								var $parent = $img.parent();
								$parent.attr('href', imgInfo.linkHref);
								$parent.attr('target', '_blank');
								$parent.attr('rel', 'noopener');
							}
							else {
								if($img.parent().is('a')) $img.unwrap();
							}
				...
				this.showLinkDialog = function (imgInfo) {
					return $.Deferred(function (deferred) {
						...
						var $imageHref = self.$dialog.find('.note-image-linkHref-text');
						...
						ui.onDialogShown(self.$dialog, function () {
							...
							$imageHref.val(imgInfo.linkHref);
